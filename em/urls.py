...
urlpatterns = [
    ...
    path('rider_prepare_to_go_with_time/<int:rider_id>/<int:track_id>/<int:stage_id>', views.rider_prepare_to_go_with_time, name='rider_prepare_to_go_with_time'),
    path('rider_prepare_to_go_with_points/<int:rider_id>/<int:track_id>/<int:stage_id>', views.rider_prepare_to_go_with_points, name='rider_prepare_to_go_with_points'),
